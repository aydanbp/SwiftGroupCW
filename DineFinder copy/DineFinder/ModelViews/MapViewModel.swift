...
class MapViewModel: ObservableObject {
    ...
    //Turns string to usable location coordinates
    func getCoordinates(query: String, locale: String) {
        let geocoder = CLGeocoder()
        geocoder.geocodeAddressString(locale) { placemarks, error in //Search for string address
    ...
    //Uses cooridnates from map as location
